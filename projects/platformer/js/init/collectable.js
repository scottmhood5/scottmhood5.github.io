(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve,500,450,6,0.7); //1
        collectable.create(type.grace,700,300,5,1); //2
        collectable.create(type.kennedi,75,250,4,0.2); //3
        collectable.create(type.max,700,0,8,0.5); //4
